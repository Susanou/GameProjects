...
static struct FScriptStruct_CoopGame_StaticRegisterNativesFHitScanTrace
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHitScanTrace_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "// Contains info of a single hitscan weapon linetrace\n" },
		{ "ModuleRelativePath", "Public/SWeapon.h" },
		{ "ToolTip", "Contains info of a single hitscan weapon linetrace" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FHitScanTrace_Hash() { return 3755120359U; }
	...
	static FName NAME_ASWeapon_OnFire = FName(TEXT("OnFire"));
	void ASWeapon::OnFire(int32 CurrentNumberBullets)
	{
		SWeapon_eventOnFire_Parms Parms;
		Parms.CurrentNumberBullets=CurrentNumberBullets;
		ProcessEvent(FindFunctionChecked(NAME_ASWeapon_OnFire),&Parms);
	}
	...
	struct Z_Construct_UFunction_ASWeapon_OnFire_Statics
	{
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_CurrentNumberBullets;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_ASWeapon_OnFire_Statics::NewProp_CurrentNumberBullets = { "CurrentNumberBullets", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SWeapon_eventOnFire_Parms, CurrentNumberBullets), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASWeapon_OnFire_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASWeapon_OnFire_Statics::NewProp_CurrentNumberBullets,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASWeapon_OnFire_Statics::Function_MetaDataParams[] = {
		{ "Category", "Weapon" },
		{ "ModuleRelativePath", "Public/SWeapon.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASWeapon_OnFire_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASWeapon, nullptr, "OnFire", nullptr, nullptr, sizeof(SWeapon_eventOnFire_Parms), Z_Construct_UFunction_ASWeapon_OnFire_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASWeapon_OnFire_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASWeapon_OnFire_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ASWeapon_OnFire_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ASWeapon_OnFire()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ASWeapon_OnFire_Statics::FuncParams);
		}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bChallengeOn_MetaData[];
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASWeapon_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASWeapon_OnFire, "OnFire" }, // 1841382983
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASWeapon_Statics::NewProp_HeadShotMultiplier_MetaData[] = {
		{ "Category", "Weapon" },
		{ "ModuleRelativePath", "Public/SWeapon.h" },
	};
#endif
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASWeapon_Statics::NewProp_ReloadTime = { "ReloadTime", nullptr, (EPropertyFlags)0x0020080000010001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASWeapon, ReloadTime), METADATA_PARAMS(Z_Construct_UClass_ASWeapon_Statics::NewProp_ReloadTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASWeapon_Statics::NewProp_ReloadTime_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASWeapon_Statics::NewProp_bChallengeOn_MetaData[] = {
		{ "Category", "Weapon" },
		{ "ModuleRelativePath", "Public/SWeapon.h" },
	};
#endif
	void Z_Construct_UClass_ASWeapon_Statics::NewProp_bChallengeOn_SetBit(void* Obj)
	{
	...
	IMPLEMENT_CLASS(ASWeapon, 3846681356);
